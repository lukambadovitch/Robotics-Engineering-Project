...
class MoveItDemo:
    def __init__(self):
        ...
        table_pose.pose.position.z = (table_ground + table_size[2] / 2.0)-0.082
        ...
        box1_pose.pose.position.z = (table_ground + table_size[2] + box1_size[2] / 2.0)-0.082
        ...
        box2_pose.pose.position.z = (table_ground + table_size[2] + box2_size[2] / 2.0) -0.082
        ...
        target_pose.pose.position.z = (table_ground + table_size[2] + target_size[2] / 2.0) -0.045
        ...
        place_pose.pose.position.x = table_pose.pose.position.x - 0.30
        ...
        grasp_pose.pose.position.y -= target_size[1] / 4.0
    ...
    def make_places(self, init_pose):
        ...
        x_vals = [0, 0.015, -0.015] #, 0.01, -0.01, 0.015, -0.015]

        # A list of y shifts (meters) to try
        y_vals = [0, 0.005, -0.005, 0.01, -0.01] #, 0.015, -0.015]

        # A list of pitch angles to try
        pitch_vals = [0.005, -0.005, 0.01, -0.01, 0.02, -0.02]
